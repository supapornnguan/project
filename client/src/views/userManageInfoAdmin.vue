    ...
    <h1 style="font-weight:600; cursor:pointer" @click="gotoHome">ADMIN SHOPAHOLIC</h1>
      ...
      <div  style="margin-left:130px; margin-top:30px">
        ...
        <div>
            ...
            <p style="display:inline; position:absolute; left:300px; font-size:15px">{{customer_email}}</p>
        </div>
        <br>
        <div>
            <p style="display:inline; font-size:15px">First Name :</p>
            <p style="display:inline; position:absolute; left:300px; font-size:15px">{{customer_firstname}}</p>
        </div>
        <br>
        <div>
            <p style="display:inline; font-size:15px">Last Name :</p>
            <p style="display:inline; position:absolute; left:300px; font-size:15px">{{customer_lastname}}</p>
        </div>
        <br>
        <div>
            <p style="display:inline; font-size:15px">Phone Number :</p>
            <p style="display:inline; position:absolute; left:300px; font-size:15px">{{customer_phonenumber}}</p>
        </div>
        <br>
        <div>
            <p style="display:inline; font-size:15px">Date Time Register :</p>
            <p style="display:inline; position:absolute; left:300px; font-size:15px">{{timestamp}}</p>
        </div>
        <br>
        <br>
